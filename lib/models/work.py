        ...
        for cours in [1, 2, 3, 4]:
            ...
            for work in works:
                ...
                if image:
                    ...
                    image_path = None
                self.work_db.insert_work(work['title'], image_path, work['title_short1'], work['title_short2'], work['title_short3'], year, cours, work['public_url'], work['twitter_account'], work['twitter_hash_tag'])
                sleep(1)
        return True
